                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Helper.getPrice(_con.order.finalTax, context, style: Theme.of(context).textTheme.subtitle1)
                      ],
                    ),
                    Row(
                      children: <Widget>[
                        ...
                        Text('${_con.order.payment.status}', style: Theme.of(context).textTheme.subtitle1)
                      ],
                    ),
                    Divider(height: 20),
                    Row(
                      children: <Widget>[
                        ...
                        Helper.getPrice(_con.order.total, context, style: Theme.of(context).textTheme.headline6)
                      ],
                    ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Helper.getPrice(_con.order.total, context, style: Theme.of(context).textTheme.headline4),
                                  Text(
                              ...
                              SizedBox(
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    openMap(_con.order.deliveryAddress.latitude, _con.order.deliveryAddress.longitude);
