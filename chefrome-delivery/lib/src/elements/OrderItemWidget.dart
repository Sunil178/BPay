              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  trailing: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Helper.getPrice(widget.order.total, context, style: Theme.of(context).textTheme.headline4),
                      Text(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(widget.order.finalTax, context, style: Theme.of(context).textTheme.subtitle1)
                            ],
                          ),
                          Row(
                            children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Text('${widget.order.payment.status}', style: Theme.of(context).textTheme.subtitle1)
                            ],
                          ),
                        ],
                      ),
