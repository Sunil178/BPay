...
class _ProductWidgetState extends StateMVC<ProductWidget> {
  ...
  Future<void> createDynamicLink(bool short) async {
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://bpay.page.link',
       link: Uri.parse(
          'https://bpay.page.link/Product?productId=${_con.product.id}&herotag=${widget.routeArgument.heroTag}'),
      androidParameters: AndroidParameters(
        packageName: 'com.ssoftwares.onlinehappylifeadmin',
        minimumVersion: 0,
      ),
